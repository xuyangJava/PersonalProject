...
<link href="<%=basePath%>static/css/icon.css" rel="stylesheet" type="text/css" />
<link href="<%=basePath%>static/css/easyui.css" rel="stylesheet" type="text/css" />
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
    ...
    <div region="north" split="true" border="false"
        style="overflow: hidden; height: 30px; background: url(<%=basePath%>static/images/layout-browser-hd-bg.gif) #7f99be repeat-x center 50%; line-height: 20px; color: #fff; font-family: Verdana, 微软雅黑, 黑体">
        <span style="float: right; padding-right: 20px;" class="head">欢迎
            ...
            src="<%=basePath%>static/images/blocks.gif" width="20" height="20" align="absmiddle" />
            我的帐本</span>
        <ul id="css3menu"
    ...
    <script type="text/javascript" src="<%=basePath%>static/js/outlook.js"></script>
